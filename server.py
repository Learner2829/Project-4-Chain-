...
def start_server(text_area):
    ...
    server_socket.bind((ip_address, 9999))  # Correctly use a tuple for the bind method
...
def create_gui():
    ...
    theme_button = tk.Button(window, text="Dark", command=lambda: toggle_theme(window, text_area, message_entry, current_theme))
